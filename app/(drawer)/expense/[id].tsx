...
type ExpenseRow = { id: number; amount: number; date: string; note: string | null; category_id: number };
    ...
    const onUpdate = () => {
        ...
        try {
         ...
         WHERE id = ? AND user_id = ?`,
                [categoryId, amountNumber, toYmd(dateObj), note.trim() || null, nowIso(), expenseId, user!.id]
            );

            // ✅ nicer UI toast (top)
            AppToast.success("Updated", "Expense updated successfully.");

            // small UX: go back after a short moment
        ...
        <View style={styles.mainContainer}>
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
                ...
                >
                    ...
                    <Text style={[styles.label, { marginTop: 24, marginBottom: 10 }]}>Category</Text>
                    ...
                    <Text style={[styles.label, { marginTop: 24 }]}>Transaction Date</Text>
                    <Pressable style={styles.dateBtn} onPress={() => setShowDatePicker(true)}>
                        <Ionicons name="calendar" size={20} color="#0d9488" style={{ marginRight: 10 }} />
